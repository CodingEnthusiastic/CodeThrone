...
import { Trophy, Medal, Award, Users, ArrowLeft, ChevronLeft, ChevronRight, Zap } from 'lucide-react';
...
const RapidFireLeaderboard: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4 sm:p-6 lg:p-8">
      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8">
          <div className="flex items-center mb-4 sm:mb-0">
            <button
              onClick={() => navigate('/rapidfire/play')}
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                Lightning-fast MCQ battle champions
              </p>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
          <div className="px-6 py-4 bg-gradient-to-r from-red-600 to-yellow-600 text-white">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400">
                            {user.stats.rapidFireGamesPlayed} games • {user.stats.rapidFireGamesWon} wins
                          </p>
                        </div>
                      </div>
                    </div>
