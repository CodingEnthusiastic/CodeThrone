              ...
              return (
                ...
                >
                  <span
                    className={
                      item.special
                        ? 'bg-clip-text text-transparent bg-gradient-to-br from-yellow-400 via-yellow-300 to-yellow-200'
                        : ''
                    }
                  >
                    {item.label}
                  ...
                  {item.special && (
                    <span className="absolute -bottom-1 text-[10px] font-semibold text-yellow-400 uppercase">
                      New
                    </span>
                  )}
                </Link>
